...
int main(int argc, char *argv[])
{
  ...
  //
  // log the write only
  DUT_WRITE_DVT(DVTF_ENABLE_MIG_MEMRD_LOGGING, DVTF_ENABLE_MIG_MEMRD_LOGGING, 1);
  DUT_WRITE_DVT(DVTF_ENABLE_MIG_MEMWR_LOGGING, DVTF_ENABLE_MIG_MEMWR_LOGGING, 1);
  //
  // ============================  
