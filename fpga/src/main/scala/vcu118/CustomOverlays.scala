...
class CustomGPIOVCU118PlacedOverlay(val shell: VCU118FPGATestHarness, name: String, val designInput: GPIODesignInput, val shellInput: GPIOShellInput, gpioNames: Seq[String])
...
class CustomGPIOVCU118ShellPlacer(shell: VCU118FPGATestHarness, val shellInput: GPIOShellInput, gpioNames: Seq[String])(implicit val valName: ValName)
  extends GPIOShellPlacer[VCU118FPGATestHarness] {
